(function init() {
  ...
  class Player {
    ...
    // Set the currentTurn for player to turn and update in UI for same.
    setCurrentTurn(turn) {
  ...
  class Game {
    ...
    createGameBoard() {
      function tileClickHandler() {
        ...
        // Update tic-tact-toe after your turn.
        game.playTurn(this);
     ...
     *
     * type Type of player(X or O) it will be string
     * row Row in which move was played it will be interger
     *col Col in which move was played it will be integer
     * tile Id of the the that was clicked it will string
     */
